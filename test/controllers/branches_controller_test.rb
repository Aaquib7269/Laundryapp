...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { branch_address: @branch.branch_address, branch_name: @branch.branch_name, designation_id: @branch.designation_id, phoneno: @branch.phoneno }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { branch_address: @branch.branch_address, branch_name: @branch.branch_name, designation_id: @branch.designation_id, phoneno: @branch.phoneno }
    assert_redirected_to branch_path(assigns(:branch))
  end
