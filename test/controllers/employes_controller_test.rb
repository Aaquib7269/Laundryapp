...
class EmployesControllerTest < ActionController::TestCase
  ...
  test "should create employe" do
    assert_difference('Employe.count') do
      post :create, employe: { designation_id: @employe.designation_id, e_address: @employe.e_address, e_email: @employe.e_email, e_name: @employe.e_name, e_no: @employe.e_no }
    end
  ...
  test "should update employe" do
    patch :update, id: @employe, employe: { designation_id: @employe.designation_id, e_address: @employe.e_address, e_email: @employe.e_email, e_name: @employe.e_name, e_no: @employe.e_no }
    assert_redirected_to employe_path(assigns(:employe))
  end
