class EmployesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @employe.save
        format.html { redirect_to employes_path, notice: 'Employe was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @employe.update(employe_params)
        format.html { redirect_to employes_path, notice: 'Employe was successfully updated.' }
  ...
  private
    ...
    def employe_params
      params.require(:employe).permit(:designation_id, :e_name, :e_no, :e_address, :e_email,:branch_id,:is_active)
    end
end
